...
typedef enum { NUM_TYPE, SYMBOL_TYPE, FUNC_TYPE, LET_STATEMENT_TYPE, LET_LIST_TYPE, LET_ELEM_TYPE, CONDITIONAL_TYPE, S_EXPR_LIST_TYPE, ARG_LIST_TYPE, FUNCTION_DEFINITION_TYPE } AST_NODE_TYPE;
